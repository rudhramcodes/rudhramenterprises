...
const pageSEO = {
  '/': {
    ...
    description: 'Rudhram Enterprises is a venture-building institution creating transformative businesses across ceremonial experiences, creative expression, lifestyle, sound, and technology. Rooted in culture, driven by innovation.',
    keywords: 'venture building, startup incubator, Rudhram Enterprises, Panigrahna, Aghhori, cultural ventures, innovation, India',
  },
  '/terms': {
    ...
    keywords: 'terms of service, terms and conditions, Rudhram Enterprises legal',
  },
  '/privacy': {
    ...
    keywords: 'privacy policy, data protection, GDPR, Rudhram Enterprises',
  },
}
